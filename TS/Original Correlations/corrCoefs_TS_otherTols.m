% Creates a plot of the lag-1 correlations of the first differances of
% the deseasonalized TS values for lower tolerance levels. At the top is 
% the original data, on the left is the sz algorithm, and on the right is 
% the zfp algorithm. Tolerance levels of 1e-3 and 1e-4 are included for zfp
% and tolerance levels of 0.001 are included for sz.
...
save_path = '/glade/work/apoppick/compress_plots/TS_corr/Corr_PlotArray_TS_OtherTols.png';
