...
function[] = contrastVarianceEWTS_new(orig_data, compressed_datas, alg_prefix_list, tol_list_sz, tol_list_zfp, nLat, nLon, obs, save_dir, days, mo_length)
    ...
    % Compressed Data
            ...
            ax(j,i) = subaxis(1,1,1, 1, 'Spacing', 0, 'SpacingHoriz' , 0 , 'SpacingVert' , 0 , ... 
                'Padding', 0, 'PaddingRight', 0, 'PaddingLeft', 0 , 'PaddingTop', 0.01 , 'PaddingBottom', 0 , ... 
                'Margin', 0 , 'MarginRight', 0.03, 'MarginLeft', 0.03 , 'MarginTop', 0.05 , 'MarginBottom', 0.05, 'HoldAxis', 1);
            axesm('robinson');
            set(gca, 'LooseInset', get(gca,'TightInset'));
            framem; tightmap;
            load coast;
            ...
            text(-0.8,1.5, ['Ratio:', num2str(varRatio, 4), ...
