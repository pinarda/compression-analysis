...
% variance to the pooled variance of the original data. It covers a lower range of tolerances.
...
diff_sq = zeros(nLon-1, nLat, length(orig_jan));
...
save_path = [save_dir, 'ContrastVarianceEWTSLowTol.png'];
