% Creates a 5x2 plot of the mean of TS errors used in the technote. On the 
% left is the sz algorithm and on the right is the zfp algorithm. The 
% tolerance levels that were included are 1.0, 0.1, and 0.01, 0.001, and 0.0001 from top 
